...
namespace RTS_FORM
{
    ...
    public partial class Form1 : Form
    {
        ...
        public int intRedTank = 1; public int intBlueTank = 1;
...
//Timer Start
        private void Form1_Load(object sender, EventArgs e) { tmrCompute.Start();  tmrBlue1Shoot.Start(); tmrBlue2Shoot.Start(); tmrBlue3Shoot.Start(); tmrBlue4Shoot.Start(); tmrRedShoot1.Start(); tmrBuild.Start(); tmrBlueMove.Start(); tmrRedMove.Start(); }
...
// Red Tank Gets Shot
      //Tank 1
            ...
            { try { ptrRed1.BackColor = System.Drawing.Color.FromArgb(red1, 0, 0); red1 -= 25; }
                    ...
                    ptrBlueShoot1.Visible = false; lblConsole.Text = "Console: Red Tank Died";  ptrRed1.Visible = false; boolR1 = false; } }
        //Tank 2
            ...
            {try { ptrRed2.BackColor = System.Drawing.Color.FromArgb(red2, 0, 0); red2 -= 25; }
                    ...
                    if (RedAmount == 1) RedAmount = 0; if (RedAmount == 2) RedAmount = 1; if (RedAmount == 3) RedAmount = 2; if (RedAmount == 4) RedAmount = 3;
                    ptrBlueShoot1.Visible = false; lblConsole.Text = "Console: Red Tank got shot"; ptrRed2.Visible = false; boolR2 = false;} }
       //Tank 3
            ...
            { try { ptrRed3.BackColor = System.Drawing.Color.FromArgb(red3, 0, 0); red3 -= 25; }
                ...
                { if (RedAmount == 1) RedAmount = 0; if (RedAmount == 2) RedAmount = 1; if (RedAmount == 3) RedAmount = 2; if (RedAmount == 4) RedAmount = 3;
                    ptrBlueShoot1.Visible = false; lblConsole.Text = "Console: Red Tank got shot"; ptrRed3.Visible = false; boolR3 = false; } }
       //Tank 4
            ...
            { try { ptrRed4.BackColor = System.Drawing.Color.FromArgb(red4, 0, 0); red4 -= 25; }
                    ...
                    if (RedAmount == 1) RedAmount = 0; if (RedAmount == 2) RedAmount = 1; if (RedAmount == 3) RedAmount = 2; if (RedAmount == 4) RedAmount = 3;
                    ptrBlueShoot1.Visible = false; lblConsole.Text = "Console: Red Tank got shot"; ptrRed4.Visible = false; boolR2 = false; }  }
...
//Blue Tank Gets Shot
        //Tank 1
            ...
            { ptrRedShoot1.Visible = false;
                ...
                catch { ptrBlue1.Enabled = false; boolB1 = false; ptrBlue1.Visible = false; lblConsole.Text = "Console: Blue Tank Died"; if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4)  BlueAmount = 3; } }
        //Tank 2
            ...
            {   ptrRedShoot1.Visible = false;
                ...
                catch { ptrBlue2.Enabled = false; boolB2 = false; ptrBlue2.Visible = false; lblConsole.Text = "Console: Blue Tank Died"; if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4)  BlueAmount = 3; }  }
        //Tank 3
            ...
            {   ptrRedShoot1.Visible = false;
                ...
                catch { ptrBlue3.Enabled = false; boolB3 = false; ptrBlue3.Visible = false; lblConsole.Text = "Console: Blue Tank Died"; if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4)  BlueAmount = 3; }  }
        //Tank 4
            ...
            {   ptrRedShoot1.Visible = false;
                ...
                catch { ptrBlue4.Enabled = false; boolB4 = false; ptrBlue4.Visible = false; lblConsole.Text = "Console: Blue Tank Died"; if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4)  BlueAmount = 3; }}
 }

//Select Tanks With Buttons
        //Select Red Tank
        private void btnRedTank1_Click(object sender, EventArgs e) { if (boolR1 == true) intRedTank = 1; }
        private void btnRedTank2_Click(object sender, EventArgs e) { if (boolR2 == true) if (intRedTank == 1)  intRedTank = 2;  }
        private void btnRedTank3_Click(object sender, EventArgs e) { if (boolR3 == true) if (intRedTank == 2)intRedTank = 3; }
        private void btnRedTank4_Click(object sender, EventArgs e) { if (boolR4 == true) if (intRedTank == 3)  intRedTank = 4; }
        //Select Blue Tank
        private void btnBlueTank1_Click(object sender, EventArgs e) { if (boolB1 == true) intBlueTank = 1; }
        private void btnBlueTank2_Click(object sender, EventArgs e) { if (boolB2 == true) if (intBlueTank == 1) intBlueTank = 2; }
        private void btnBlueTank3_Click(object sender, EventArgs e) { if (boolB3 == true)if (intBlueTank == 2)intBlueTank = 3; }
        private void btnBlueTank4_Click(object sender, EventArgs e) { if (boolB4 == true)if (intBlueTank == 3)intBlueTank = 4; }
...
//Red Tank 3
  ...
  //Red Tank 1 Intersecting...
            ...
            if (ptrRed1.Bounds.IntersectsWith(Water1.Bounds) || ptrRed1.Bounds.IntersectsWith(Water2.Bounds) || ptrRed1.Bounds.IntersectsWith(Water3.Bounds))
            {
                ...
                lblConsole.Text = "Console: Red Tank Drown"; boolR1 = false;
                if (RedAmount == 1) RedAmount = 0; if (RedAmount == 2) RedAmount = 1; if (RedAmount == 3) RedAmount = 2; if (RedAmount == 4) RedAmount = 3;
            }
            ...
            if (ptrRed2.Bounds.IntersectsWith(Water1.Bounds) || ptrRed2.Bounds.IntersectsWith(Water2.Bounds) || ptrRed2.Bounds.IntersectsWith(Water3.Bounds))
            {
                ...
                lblConsole.Text = "Console: Red Tank Drown"; boolR2 = false;
                if (RedAmount == 1) RedAmount = 0; if (RedAmount == 2) RedAmount = 1; if (RedAmount == 3) RedAmount = 2; if (RedAmount == 4) RedAmount = 3;
            }
 ...
 //Move BLUE
        private void timer11_Tick(object sender, EventArgs e)
        {
            ...
            if (intBlueTank == 2 & boolB2 == true)
            {
                ...
                {
                    ptrBlueShoot2.Location = ptrBlue2.Location; ptrBlueShoot1.Visible = true; tmrBlue1Left.Start();
                ...
                if (Controller2.ThumbSticks.Right.X > 0f)
                {
                    ...
                    tmrBlue1Down.Enabled = false; tmrBlue1Up.Enabled = false; tmrBlue1Left.Enabled = false;
                }
                ptrBlue1.Location = new System.Drawing.Point(bluex2, bluey2);
            }
            //Blue Tank 3
            if (intBlueTank == 3 & boolB3 == true)
            {
                ...
                ptrBlue1.Location = new System.Drawing.Point(bluex3, bluey3);
            }
            //Blue Tank 4
            if (intBlueTank == 4 & boolB4 == true)
            {
                ...
                if (Controller2.ThumbSticks.Right.X < 0f)
                {
                    ptrBlueShoot2.Location = ptrBlue4.Location; ptrBlueShoot1.Visible = true; tmrBlue1Left.Start();
                    tmrBlue1Down.Enabled = false; tmrBlue1Right.Enabled = false; tmrBlue1Up.Enabled = false;
                }
                if (Controller2.ThumbSticks.Right.Y < 0f)
                {
                ...
                ptrBlue1.Location = new System.Drawing.Point(bluex4, bluey4);
            }
            //Right Wall
            ...
            if (ptrBlue1.Bounds.IntersectsWith(Water1.Bounds) || ptrBlue1.Bounds.IntersectsWith(Water2.Bounds) || ptrBlue1.Bounds.IntersectsWith(Water3.Bounds))
            {
                ...
                lblConsole.Text = "Console: Blue Tank Drown"; boolB1 = false;
            ...
            if (ptrBlue2.Bounds.IntersectsWith(Water1.Bounds) || ptrBlue2.Bounds.IntersectsWith(Water2.Bounds) || ptrBlue2.Bounds.IntersectsWith(Water3.Bounds))
            {
                ...
                lblConsole.Text = "Console: Blue Tank Drown"; boolB2 = false;
                if (BlueAmount == 1) BlueAmount = 0; if (BlueAmount == 2) BlueAmount = 1; if (BlueAmount == 3) BlueAmount = 2; if (BlueAmount == 4) { BlueAmount = 3; }
            }
        }
        ...
        //Tank 1
            if (intBlueTank == 1 & boolB1 == true){
                ...
                //Left
                if (Controller2.ThumbSticks.Right.X < 0f)
                {ptrBlueShoot2.Location = ptrBlue1.Location; ptrBlueShoot1.Visible = true; tmrBlue1Left.Start();
                    tmrBlue1Down.Enabled = false; tmrBlue1Right.Enabled = false; tmrBlue1Up.Enabled = false; }
                //Down
                if (Controller2.ThumbSticks.Right.Y < 0f)
                {ptrBlueShoot1.Location = ptrBlue1.Location; ptrBlueShoot1.Visible = true; tmrBlue1Down.Start();
     ...
     //Tank 3
            if (intBlueTank == 3 & boolB3 == true) {
                ...
                //Left
                if (Controller2.ThumbSticks.Right.X < 0f)
                { ptrBlueShoot2.Location = ptrBlue3.Location; ptrBlueShoot1.Visible = true; tmrBlue1Left.Start();
                    tmrBlue1Down.Enabled = false; tmrBlue1Right.Enabled = false; tmrBlue1Up.Enabled = false;   }
                //Down
                if (Controller2.ThumbSticks.Right.Y < 0f)
...
//Red Shoot
        ...
        private void tmrCompute_Tick(object sender, EventArgs e)
        {
            ...
            {if (RedTanksMade == 1) { ptrRed2.Top += 35; boolR2 = true; intRedProgress = 0; RedTanksMade++; }
                if (RedTanksMade == 2 & intRedProgress == 100) { ptrRed3.Top += 35; boolR3 = true; intRedProgress = 0; RedTanksMade++; }
                if (RedTanksMade == 3 & intRedProgress == 100) { ptrRed4.Left -= 35; boolR4 = true; intRedProgress = 0; RedTanksMade++; lblRedProgress.Visible = false; } intRedProgress = 0;  }

            if (intBlueProgress == 100)
            {if (BlueTanksMade == 1) { ptrBlue2.Top -= 35; boolR2 = true; intBlueProgress = 0; BlueTanksMade = 2; }
                if (BlueTanksMade == 2 & intBlueProgress == 100) { ptrBlue3.Top -= 35; boolR3 = true; intBlueProgress = 0; BlueTanksMade = 3; }
                if (BlueTanksMade == 3 & intBlueProgress == 100) { ptrBlue4.Left += 35; boolR4 = true; intBlueProgress = 0; BlueTanksMade = 4; lblBlueProgress.Visible = false; }intBlueProgress = 0;}
        }
